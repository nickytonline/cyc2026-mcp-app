    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          variant="outline"
          size="sm"
          className="h-8 gap-1 rounded-[8px] border-[var(--cyc-line)] bg-white px-2.5 font-mono text-[0.6875rem] font-bold uppercase tracking-wider text-[var(--cyc-ink)] hover:bg-[var(--cyc-cloud)] dark:border-white/10 dark:bg-[var(--cyc-navy)] dark:text-white"
